...
datams_wactnam$activityId <- factor(datams_wactnam$activityId, levels = activity_label[, 1], labels = activity_label[,2])
datams_wactnam$subjectId <- as.factor(datams_wactnam$subjectId)
